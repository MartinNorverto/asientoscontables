		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#pampaportalclientesasientoscontables-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pampaportalclientesasientoscontables-display": {
								"semanticObject": "pampaportalclientesasientoscontables",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pampa.portalclientes.asientoscontables",
									"url": sap.ui.require.toUrl("pampa/portalclientes/asientoscontables")
								}
							}
						}
					}
